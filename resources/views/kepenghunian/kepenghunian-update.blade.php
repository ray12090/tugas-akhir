        ...
        <div class="p-6 bg-white overflow-hidden shadow-sm sm:rounded-2xl">
            <div>
                ...
                <div class="text-gray-500 text-sm font-reguler">
                    {{ __('Di bawah merupakan formulir untuk mengedit data penghuni') }}
                </div>
            </div>
            <div class="relative sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div class="w-full">
                        <form action="{{ route('kepenghunian.update', $kepenghunian->id) }}" method="POST"
                            ...
                            <div class="grid gap-4 sm:grid-cols-3 sm:gap-6">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" id="unit_name" name="unit_name" placeholder="X-1234"
                                            value="{{ old('unit_name', $kepenghunian->unit->unit ?? '') }}"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                        <input type="hidden" id="unit_id" name="unit_id"
                                            value="{{ old('unit_id', $kepenghunian->unit_id) }}">
                                ...
                                <div class="w-full">
                                    ...
                                    <input type="date" name="tanggal_huni" id="tanggal_huni"
                                        value="{{ old('tanggal_huni', $kepenghunian->tanggal_huni) }}" required
                                ...
                                <div class="w-full mb-4">
                                    ...
                                    <select name="status" id="status" value="{{ old('status', $kepenghunian->status) }}"
                                        required
                                    ...
                                    <div class="w-full">
                                        ...
                                        <div class="relative">
                                            <input type="text" name="nama" id="nama"
                                                value="{{ old('nama', $kepenghunian->nama) }}" required
                                    ...
                                    <div class="w-full">
                                        ...
                                        <div class="relative">
                                            <input type="text" name="no_hp" id="no_hp"
                                                value="{{ old('no_hp', $kepenghunian->no_hp) }}" required
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    ...
                                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                                        <div class="w-full">
                                            ...
                                            <input type="text" name="tempat_lahir" id="tempat_lahir"
                                                value="{{ old('tempat_lahir', $kepenghunian->tempat_lahir) }}" required
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        ...
                                        <div class="w-full">
                                            ...
                                            <input type="date" name="tanggal_lahir" id="tanggal_lahir"
                                                value="{{ old('tanggal_lahir', $kepenghunian->tanggal_lahir) }}"
                                                required
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                required>
                                        </div>
                                        <div class="w-full">
                                            ...
                                            <select name="warga_negara" id="warga_negara"
                                                value="{{ old('warga_negara', $kepenghunian->warga_negara) }}" required
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="no_ktp" id="no_ktp"
                                            value="{{ old('no_ktp', $kepenghunian->no_ktp) }}" required
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                ...
                                <div class="w-full">
                                    ...
                                    <select name="agama" id="agama" value="{{ old('agama', $kepenghunian->agama) }}"
                                        required
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                ...
                                <div class="w-full">
                                    ...
                                    <textarea name="alamat" id="alamat" rows="6"
                                        ...
                                        required>{{ old('alamat', $kepenghunian->alamat) }} </textarea>
                                </div>
                                <div class="sm:col-span-2"></div>
                                    ...
                                    <div class="flex items-center">
                                        <div class="relative">
                                            ...
                                            <input name="awal_sewa" id="awal_sewa" type="date"
                                                value="{{ old('awal_sewa', $kepenghunian->awal_sewa) }}" required
                                        ...
                                        <div class="relative">
                                            ...
                                            <input name="akhir_sewa" id="akhir_sewa" type="date"
                                                value="{{ old('akhir_sewa', $kepenghunian->akhir_sewa) }}" required
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
