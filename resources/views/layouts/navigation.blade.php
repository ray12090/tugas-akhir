                ...
                @if (Auth::user()->tipe_user_id == 1)
                    <li>
                        <button type="button"
                            ...
                            aria-controls="data-akun" data-collapse-toggle="data-akun">
                            <svg class="w-6 h-6 text-[#016452] transition duration-75 group-hover:text-[#014F41]"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                fill="currentColor" viewBox="0 0 24 24">
                                <path fill-rule="evenodd"
                        ...
                        <ul id="data-akun" class="hidden py-2 space-y-2">
                            <li>
                                <a href="{{ route('akun.index') }}"
                                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">{{ __('Semua Akun') }}</a>
                            </li>
                            <li>
                                <a href="{{ route('tipe_user.index') }}"
                                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">{{ __('Semua Tipe User') }}</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <button type="button"
                            class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group w-full"
                            aria-controls="data-master" data-collapse-toggle="data-master">
                            <svg class="w-6 h-6 text-[#016452] transition duration-75 group-hover:text-[#014F41]"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                fill="currentColor" viewBox="0 0 24 24">
                                <path fill-rule="evenodd"
                        ...
                        <ul id="data-master" class="hidden py-2 space-y-2">
                            <li>
                                <a href="{{ route('detail_agama.index') }}"
                                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">{{ __('Daftar Agama') }}</a>
                            </li>
                            <li>
                                <a href="{{ route('detail_perkawinan.index') }}"
                                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">{{ __('Daftar Perkawinan') }}</a>
                            </li>
                            <li>
                                <a href="{{ route('detail_kewarganegaraan.index') }}"
                                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">{{ __('Daftar Kewarganegaraan') }}</a>
                            </li>
                            <li>
                                <a href="{{ route('detail_tempat_lahir.index') }}"
                                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">{{ __('Daftar Tempat Lahir') }}</a>
                            </li>
                        </ul>
                    </li>
            </ul>
            @endif
            @if (Auth::user()->tipe_user_id == 3 || Auth::user()->tipe_user_id == 2 || Auth::user()->tipe_user_id == 1)
                ...
                <li>
                    ...
                    <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
                        <button type="button" href="#"
                            class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group w-full">
                            <svg class="w-6 h-6 text-[#016452] transition duration-75 group-hover:text-[#014F41]" aria-hidden="true"
                    ...
                    <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
                        <li>
                            <button href="{{ route('ipl.index') }}"
                                class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group w-full"
                                aria-controls="data-biaya" data-collapse-toggle="data-biaya">
                                <svg class="w-6 h-6 text-[#016452] transition duration-75 group-hover:text-[#014F41]"
                                ...
                                <span
                                    class="flex-1 ms-4 text-left rtl:text-right whitespace-nowrap">{{ __('IPL') }}
                                </span>
                                <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    fill="none" viewBox="0 0 10 6">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <ul id="data-biaya" class="hidden py-2 space-y-2">
                                <li>
                                    <a href="{{ route('ipl.index') }}"
                                        class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">{{ __('Semua IPL') }}</a>
                                </li>
                                <li>
                                    <a href="{{ route('detail_biaya_admin.index') }}"
                                        class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">{{ __('Data Biaya Admin') }}</a>
                                </li>
                                <li>
                                    <a href="{{ route('detail_biaya_air.index') }}"
                                        class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">{{ __('Data Biaya Air') }}</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
