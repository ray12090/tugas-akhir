    ...
    <nav
        ...
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                <button data-drawer-target="sidenav" data-drawer-toggle="sidenav"
                    aria-controls="sidenav"
                    class="p-2 mr-2 text-gray-600 rounded-lg hover:text-gray-900 hover:bg-gray-100 focus:bg-gray-100 dark:focus:bg-gray-700 focus:ring-2 focus:ring-gray-100 dark:focus:ring-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
            ...
            <div class="flex flex-col space-y-2 items-center">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <button type="submit"
                        ...
                        <svg class="w-6 h-6 text-gray-800 dark:text-white inline-block align-middle"
            ...
            <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
                <li>
                    <a href="{{ route('home') }}"
                        ...
                        <span class="ml-3">{{ __('Beranda') }}</span>
                    </a>
                </li>
                @if (Auth::user()->usertype === 'admin' &&
                        Auth::user()->usertype !== 'fa' &&
                        Auth::user()->usertype !== 'tr' &&
                        Auth::user()->usertype !== 'eg')
                    <li>
                        <a href="{{ route('akun.index') }}"
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap">{{ __('Data Akun') }}</span>
                        </a>
                    </li>
                @endif
                <li>
                ...
                @if (Auth::user()->usertype === 'fa' &&
                    ...
                    <li>
                        <a href="{{ route('ipl.index') }}"
                            ...
                            <span class="flex-1 ml-3 whitespace-nowrap">{{ __('IPL') }}</span>
                        </a>
                    </li>
                @endif
            </ul>
