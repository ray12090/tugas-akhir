                        ...
                        <form action="{{ route('lantai.store') }}" method="POST" enctype="multipart/form-data" onsubmit="return confirmSave(this);">
                            ...
                            <div class="grid gap-4 sm:grid-cols-4 sm:gap-6">
                                ...
                                <div class="sm:col-span-1">
                                    ...
                                    <button type="button" id="add-floor" class="inline-flex items-center py-2.5 px-5 mt-2 mb-2 text-sm font-medium text-center text-white bg-[#016452] rounded-lg focus:ring-4 focus:ring-[#014f415e] dark:focus:ring-primary-900 hover:bg-[#014F41]">+ {{ __('Tambah Lantai') }}</button>
                                </div>
                                <div class="sm:col-span-1">
                                    ...
                                    <button type="button" id="generate-floor-range" class="inline-flex items-center py-2.5 px-5 mt-2 mb-2 text-sm font-medium text-center text-white bg-[#016452] rounded-lg focus:ring-4 focus:ring-[#014f415e] dark:focus:ring-primary-900 hover:bg-[#014F41]">{{ __('Generate Lantai')}}</button>
                                </div>
