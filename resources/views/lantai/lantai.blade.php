            ...
            <div class="relative sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div
                        ...
                        <a href="{{ route('lantai.create') }} " type="button" id="createProductButton"
                    ...
                    <table class="w-screen text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                <th class="p-4">
                                    <a
                                        href="{{ route('lantai.index', ['sort_by' => 'tower_id', 'sort_order' => $sortBy === 'tower_id' && $sortOrder === 'asc' ? 'desc' : 'asc']) }}">
                                        {{ __('Nama Tower') }}
                                        @if ($sortBy === 'tower_id')
                                ...
                                <th class="p-4">
                                    <a
                                        href="{{ route('lantai.index', ['sort_by' => 'nama_lantai', 'sort_order' => $sortBy === 'nama_lantai' && $sortOrder === 'asc' ? 'desc' : 'asc']) }}">
                                        {{ __('Nama Lantai') }}
                            ...
                            @foreach($lantais as $lantai)
                                <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $lantai->tower->nama_tower }}</td>
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $lantai->nama_lantai }}</td>
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                ...
                <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
                    ...
                    <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                        Showing
                        <span class="font-semibold text-gray-900 dark:text-white">{{ $lantais->firstItem() }}</span>
                        to
                        <span class="font-semibold text-gray-900 dark:text-white">{{ $lantais->lastItem() }}</span>
                        of
                        <span class="font-semibold text-gray-900 dark:text-white">{{ $lantais->total() }}</span>
                    </span>
