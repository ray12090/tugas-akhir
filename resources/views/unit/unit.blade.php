            ...
            <div class="relative sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div class="w-full md:w-1/2">
                        <form method="GET" action="{{ route('unit.index') }}" class="flex items-center">
                            <div class="relative w-full">
                                ...
                                <input type="text" name="search" id="simple-search" placeholder="{{ __('Cari Unit') }}"
                    ...
                    <div
                        ...
                        <a href="{{ route('unit.create') }} " type="button" id="createProductButton"
                    ...
                    <table class="w-screen text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                <th class="p-4">
                                    <a
                                        href="{{ route('unit.index', ['sort_by' => 'nama_tower', 'sort_order' => $sortBy === 'nama_tower' && $sortOrder === 'asc' ? 'desc' : 'asc']) }}">
                                        {{ __('Nama Tower') }}
                                ...
                                <th class="p-4">
                                    <a
                                        href="{{ route('unit.index', ['sort_by' => 'nama_lantai', 'sort_order' => $sortBy === 'nama_lantai' && $sortOrder === 'asc' ? 'desc' : 'asc']) }}">
                                        {{ __('Nama Lantai') }}
                                ...
                                <th class="p-4">
                                    <a
                                        href="{{ route('unit.index', ['sort_by' => 'nama_unit', 'sort_order' => $sortBy === 'nama_unit' && $sortOrder === 'asc' ? 'desc' : 'asc']) }}">
                                        {{ __('Nama Unit') }}
                                        @if ($sortBy === 'nama_unit')
                                            <svg class="w-4 h-4 inline" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            @foreach($units as $unit)
                                <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $unit->lantai->tower->nama_tower }}</td>
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $unit->lantai->nama_lantai }}</td>
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $unit->nama_unit }}</td>
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                ...
                <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
                    ...
                    <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                        Showing
                        <span class="font-semibold text-gray-900 dark:text-white">{{ $units->firstItem() }}</span>
                        to
                        <span class="font-semibold text-gray-900 dark:text-white">{{ $units->lastItem() }}</span>
                        of
                        <span class="font-semibold text-gray-900 dark:text-white">{{ $units->total() }}</span>
                    </span>
