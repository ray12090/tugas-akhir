                ...
                <div class="relative sm:rounded-lg overflow-hidden">
                    <div class="flex flex-col md:flex-row items-stretch md:items-center md:space-x-3 space-y-3 md:space-y-0 justify-between mx-4 py-4 dark:border-gray-700">
                        <div class="w-full md:w-1/2">
                            <form method="GET" action="{{ route('unit') }}" class="flex items-center">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    <th class="p-4">
                                        <a href="{{ route('unit', array_merge(request()->query(), ['sort_by' => 'tower', 'sort_order' => request('sort_order') === 'asc' ? 'desc' : 'asc'])) }}">
                                            Tower
                                    ...
                                    <th class="p-4">
                                        <a href="{{ route('unit', array_merge(request()->query(), ['sort_by' => 'lantai', 'sort_order' => request('sort_order') === 'asc' ? 'desc' : 'asc'])) }}">
                                            Lantai
                                            @if (request('sort_by') === 'lantai')
                                                @if (request('sort_order') === 'asc')
                                                    &#9650;
                                                @else
                                                    &#9660;
                                    ...
                                    <th class="p-4">
                                        <a href="{{ route('unit', array_merge(request()->query(), ['sort_by' => 'unit', 'sort_order' => request('sort_order') === 'asc' ? 'desc' : 'asc'])) }}">
                                            Unit
                            ...
                            <tbody>
                                ...
                                <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $unit->tower }}</td>
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $unit->lantai }}</td>
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $unit->unit }}</td>
