                            ...
                            <div class="grid gap-4 sm:grid-cols-4 sm:gap-6">
                                ...
                                <div class="sm:col-span-1">
                                    ...
                                    <div class="relative max-w sm:col-span-1">
                                        ...
                                        <input id="tanggal_akhir_berlaku" name="tanggal_akhir_berlaku" type="text" datepicker 
                                        datepicker-format="yyyy-mm-dd" 
                                        datepicker-buttons datepicker-autoselect-today class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
