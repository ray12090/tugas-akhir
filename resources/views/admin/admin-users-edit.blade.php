        ...
        <div class="p-6 bg-white overflow-hidden shadow-sm sm:rounded-2xl">
            ...
            <div class="relative sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div class="w-full">
                        <form action="{{ route('akun.update', $user->id) }}" method="POST" enctype="multipart/form-data" onsubmit="return confirmSave(this);">
                            @csrf
                            @method('PUT')
                            <div class="grid gap-4 sm:grid-cols-4 sm:gap-6">
                                ...
                                <div class="w-full">
                                    ...
                                    <select name="usertype" id="usertype"
                                        ...
                                        <option value="eg" {{ old('usertype', $user->usertype) == 'eg' ? 'selected' : '' }}>Engineering</option>
                                        <option value="fa" {{ old('usertype', $user->usertype) == 'fa' ? 'selected' : '' }}>Finance</option>
                                        <option value="tr" {{ old('usertype', $user->usertype) == 'tr' ? 'selected' : '' }}>Tenant Relation</option>
                                    </select>
                                </div>
                                <div class="sm:col-span-3"></div>
