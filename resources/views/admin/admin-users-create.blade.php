                        ...
                        <form action="{{ route('akun.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="grid gap-4 sm:grid-cols-4 sm:gap-6">
                                ...
                                <div class="w-full">
                                    ...
                                    <select name="tipe_user_id" id="tipe_user_id"
                                        ...
                                        @foreach ($tipeUsers as $tipe)
                                            <option id="tipe_user_{{ $tipe->id }}" name="tipe_user_id[]"
                                                value="{{ $tipe->id }}">
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <button type="submit"
                                        class="inline-flex items-center py-2.5 px-5 me-2 mb-2 text-sm font-medium text-center text-white bg-[#016452] rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-[#014F41]">
