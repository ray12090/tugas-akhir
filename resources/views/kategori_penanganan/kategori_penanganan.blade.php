        ...
        <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg">
            <div class="px-6 pt-6">
                <div class="mb-4 text-xl font-bold text-gray-900 dark:text-white">
                    {{ __('Data Kategori Penanganan') }}
                </div>
                <div class="text-gray-500 text-sm font-regular">
                    {{ __('Di bawah merupakan tabel data kategori penanganan. Isi tabel ini dapat ditambah, lihat, ubah, dan hapus oleh Tenant Relation.') }}
                </div>
            </div>
            <div
                ...
                <div class="w-full md:w-1/2">
                    <form method="GET" action="{{ route('kategori_penanganan.index') }}" class="flex items-center">
            ...
            <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
                ...
                <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                    Showing
                    <span class="font-semibold text-gray-900 dark:text-white">{{ $kategoris->firstItem() }}</span>
                    to
                    <span class="font-semibold text-gray-900 dark:text-white">{{ $kategoris->lastItem() }}</span>
                    of
                ...
                <ul class="inline-flex items-stretch -space-x-px">
                    ...
                    @else
                        <li>
                            <a href="{{ $kategoris->previousPageUrl() }}" rel="prev"
                    ...
                    @if ($kategoris->hasMorePages())
                        <li>
                            <a href="{{ $kategoris->nextPageUrl() }}" rel="next"
