                        ...
                        <form action="{{ route('penyewa.update', $penyewa->id) }}" method="POST"
                            ...
                            <div class="grid gap-4 sm:grid-cols-4 sm:gap-6">
                                    ...
                                    <div class="sm:col-span-1">
                                        ...
                                        <select name="jenis_kelamin" id="jenis_kelamin"
                                            ...
                                            <option value="Laki-laki"
                                                {{ $penyewa->jenis_kelamin == 'Laki-laki' ? 'selected' : '' }}>
                                                {{ __('Laki-laki') }}</option>
                                            <option value="Perempuan"
                                                {{ $penyewa->jenis_kelamin == 'Perempuan' ? 'selected' : '' }}>
                                                {{ __('Perempuan') }}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="grid gap-4 sm:grid-cols-3 sm:gap-6 mb-4">
                                    ...
                                    <div class="sm:col-span-1">
                                        <label for="awal_sewa" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                            {{ __('Awal Sewa') }}
                                        </label>
                                        <div class="relative">
                                            <input id="awal_sewa" name="awal_sewa" type="text" datepicker datepicker-format="yyyy-mm-dd"
                                                datepicker-buttons datepicker-orientation="{auto}"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="YYYY/MM/DD" value="{{ $penyewa->awal_sewa }}"required>
                                        </div>
                                    </div>
                                    <div class="sm:col-span-1">
                                        <label for="akhir_sewa" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                            {{ __('Akhir Sewa') }}
                                        </label>
                                        <div class="relative">
                                            <input id="akhir_sewa" name="akhir_sewa" type="text" datepicker datepicker-format="yyyy-mm-dd"
                                                datepicker-buttons datepicker-orientation="{auto}"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
