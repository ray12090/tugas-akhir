                    ...
                    <ul>
                        <li class="mb-6">
                            <button type="button"
                                ...
                                data-collapse-toggle="data-master">
                                <svg class="w-6 h-6 text-white transition duration-75" aria-hidden="true"
                            ...
                            <ul id="data-master"
                                class="hidden pb-2 rounded-b-lg space-y-2 bg-[#016452bb]">
                                <li>
                                    <a href="{{ route('ipl.showIPL', ['unit_id' => $penyewa->unit_id]) }}"
                                ...
                                <li>
                                    <a href="{{ route('ipl.history', ['unit_id' => $penyewa->unit_id]) }}"
