        ...
        <div class="p-6 bg-white overflow-hidden shadow-sm sm:rounded-2xl">
            ...
            <div class="relative sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div class="w-full">
                        <form @csrf <div class="grid gap-4 sm:grid-cols-4 sm:gap-6">
                            ...
                            <form id="billingForm">
                                ...
                                <div class="w-full">
                                    ...
                                    <input type="number" id="total_tagihan_belum_dibayar"
                                        name="total_tagihan_belum_dibayar"
                                        ...
                                        value="{{ $ipl->total_tagihan_belum_dibayar }}" readonly>
                                </div>
                                <div class="w-full">
                                    ...
                                    <input type="number" id="titipan_pengelolaan" name="titipan_pengelolaan"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                                        value="{{ $ipl->titipan_pengelolaan }}" readonly>
                                </div>
                                <div class="w-full">
                                    ...
                                    <input type="number" id="titipan_air" name="titipan_air"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                                        value="{{ $ipl->titipan_air }}" readonly>
                                </div>
                                ...
                                <div class="w-full">
                                    ...
                                    <input type="number" id="iuran_pengelolaan" name="iuran_pengelolaan"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                                        value="{{ $ipl->iuran_pengelolaan }}" readonly>
                                </div>
                                <div class="w-full">
                                    ...
                                    <input type="number" id="dana_cadangan" name="dana_cadangan"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                                        value="{{ $ipl->dana_cadangan }}" readonly>
                                </div>
                                <div class="sm:col-span-4">
                                    ...
                                    <div class="grid gap-4 sm:grid-cols-6 sm:gap-6">
                                        <div class="w-full">
                                            ...
                                            <input type="number" id="meter_air_awal" name="meter_air_awal"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                                                value="{{ $ipl->meter_air_awal }}" readonly>
                                        </div>
                                        <div class="w-full">
                                            ...
                                            <input type="number" id="meter_air_akhir" name="meter_air_akhir"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                                                value="{{ $ipl->meter_air_akhir }}" readonly>
                                        </div>
                                        <div class="w-full">
                                ...
                                @if ($ipl->foto_bukti_pembayaran)
                                    <div>
                                        <img src="{{ asset('storage/bukti_pembayaran/' . $ipl->foto_bukti_pembayaran) }}"
                                            alt="Foto Bukti Pembayaran" class="w-full h-auto rounded-lg">
                                    </div>
                                @else
                                    <p class="text-gray-500">{{ __('Tidak ada foto bukti pembayaran.')}}</p>
                                @endif
                            </div>
                            <div class="sm:col-span-2"></div>
                            <div class="sm:col-span-1"></div>
                            <div class="w-full">
                                ...
                                <select name="status" id="status"
                                    ...
                                    disabled>
                                    <option value="Belum Lunas" {{ $ipl->status == 'Belum Lunas' ? 'selected' : '' }}>Belum Lunas</option>
                                    <option value="Lunas" {{ $ipl->status == 'Lunas' ? 'selected' : '' }}>Lunas</option>
                                </select>
                            </div>
                            <div class="sm:col-span-2"></div>
                            <div class="sm:col-span-1"></div>
