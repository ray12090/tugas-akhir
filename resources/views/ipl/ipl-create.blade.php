                                ...
                                <div class="grid gap-4 sm:grid-cols-4 sm:gap-6">
                                    ...
                                    <div class="w-full">
                                        <label for="foto_bukti_pembayaran"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('Bukti Pembayaran')}}</label>
                                        <input type="file" name="foto_bukti_pembayaran" id="foto_bukti_pembayaran"
                                            class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                            aria-describedby="foto_analisis_awal">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function setUnitId(unitName) {
                ...
                if (matchedUnit) {
                    ...
                    // Fetch nama dan alamat dari unit dengan status 'pemilik'
                    fetch(`/get-owner-info/${matchedUnit[0]}`)
