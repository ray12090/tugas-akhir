        ...
        <div class="p-6 bg-white overflow-hidden shadow-sm sm:rounded-2xl">
            ...
            <div class="relative sm:rounded-lg overflow-hidden">
                <div class="flex flex-col md:flex-row items-stretch md:items-center md:space-x-3 space-y-3 md:space-y-0 justify-between py-4 dark:border-gray-700">
                    <div class="w-full">
                        <form action="{{ route('penanganan.store') }}" method="POST" enctype="multipart/form-data" onsubmit="return confirmSave(this);">
                            @csrf
                            <div class="grid gap-4 sm:grid-cols-4 sm:gap-6">
                                        ...
                                        @foreach ($kategoriPenanganans as $kategori)
                                            <li class="border border-gray-200 dark:border-gray-600 py-1 px-4 rounded-lg">
                                                <div class="flex items-center">
                                                    <input id="kategori_penanganan_{{ $kategori->id }}" type="checkbox" value="{{ $kategori->id }}" name="kategori_penanganan_id[]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 items-end rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                                            ...
                                                            @foreach ($users as $user)
                                                                <li class="border border-gray-200 dark:border-gray-600 py-1 px-4 rounded-lg">
                                                                    <div class="items-center flex">
                                                                        <input id="users_{{ $user->id }}" type="checkbox" value="{{ $user->id }}" name="users_id[]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 items-end rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                ...
                                <div class="grid gap-4 sm:col-span-2 sm:grid-cols-1 sm:gap-6">
                                    <div class="sm:row-span-2">
                                        ...
                                        <div class="flex items-center">
                                            <input id="persetujuan_selesai_tr" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" disabled>
                                    ...
                                    <div class="sm:row-span-2">
                                        ...
                                        <div class="flex items-center">
                                            <input id="persetujuan_selesai_pelaksana" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" disabled>
