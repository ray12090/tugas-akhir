<x-app-layout>
    ...
    <script>
        ...
        function updateSelectedUsers(userName, isChecked) {
            ...
            if (isChecked) {
                ...
                badge.setAttribute('data-user', userName); // Store username in data attribute
                selectedUsersContainer.appendChild(badge);
            } else {
                // Remove badge
                const badges = selectedUsersContainer.querySelectorAll('span');
                badges.forEach(badge => {
                    if (badge.getAttribute('data-user') === userName) {
                        badge.remove();
                    }
                });
            }
