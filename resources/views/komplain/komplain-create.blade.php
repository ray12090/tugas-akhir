                    ...
                    <div class="w-full">
                        <form action="{{ route('komplain.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="grid gap-4 sm:grid-cols-4 sm:gap-6">
                                ...
                                <div class="w-full">
                                    <label for="unit_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('Tower')}}</label>
                                    <div class="relative">
                                ...
                                <div class="w-full">
                                    <label for="respon"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Respon</label>
                                ...
                                <div class="w-full">
                                    <label for="analisis_awal"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Analisis
                                        Awal</label>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            unitInput.addEventListener('input', function () {
                ...
                const matchedUnit = Object.entries(units).find(([id, unit]) => unit.toLowerCase() === inputValue);
