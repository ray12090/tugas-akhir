                            ...
                            <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    @if ($komplain->status_komplain_id == 4)
                                        <span
                                            class="bg-red-100 text-red-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full dark:bg-red-900 dark:text-red-300 border border-red-500">{{ $komplain->statusKomplain->nama_status_komplain }}</span>
                                    ...
                                    @elseif ($komplain->status_komplain_id == 1)
                                        <span
                                            class="bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full dark:bg-blue-900 dark:text-blue-300 border border-blue-500">{{ $komplain->statusKomplain->nama_status_komplain }}</span>
                                    @else ()
                                        <span
